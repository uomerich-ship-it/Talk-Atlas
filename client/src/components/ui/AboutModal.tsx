      ...
      >
        ...
        <div className="max-w-2xl mx-auto px-6 py-16">
          ...
          >
            ...
            <p className="text-muted-foreground/30 text-[10px] uppercase tracking-widest mt-3">Version 1.0.0</p>
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-10"
          >
            <h2 className="text-lg font-bold text-primary/80 mb-3" style={{ fontFamily: 'Oxanium, system-ui, sans-serif' }}>
              What is TalkAtlas?
            </h2>
          ...
          <motion.div
            ...
            className="mb-10"
          >
            <h2 className="text-lg font-bold text-primary/80 mb-4" style={{ fontFamily: 'Oxanium, system-ui, sans-serif' }}>
              Features
            </h2>
          ...
          >
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/5 border border-white/10 hover:border-primary/30 text-muted-foreground hover:text-primary transition-all text-xs font-bold uppercase tracking-wider"
          ...
          >
            <p className="text-[10px] text-muted-foreground/30 text-center uppercase tracking-widest mb-3">Powered by</p>
            <div className="flex justify-center gap-3 flex-wrap mb-6">
              {['DeepL', 'OpenAI', 'Google Places', 'RevenueCat'].map(t => (
                <span key={t} className="text-[10px] px-3 py-1 rounded-full bg-white/5 border border-white/10 text-muted-foreground/40 font-bold uppercase tracking-wider">
                  {t}
                </span>
              ))}
            </div>
            <p className="text-center text-xs text-muted-foreground/40 mb-1">
              Made with {'\u2764\u{FE0F}'} for travellers worldwide
            </p>
            <p className="text-center text-[10px] text-muted-foreground/20 mb-3">
              {'\u00A9'} 2025 TalkAtlas
            </p>
            <div className="flex justify-center gap-4">
              <button className="text-[10px] text-muted-foreground/30 hover:text-primary transition-colors" data-testid="button-privacy-policy">Privacy Policy</button>
              <button className="text-[10px] text-muted-foreground/30 hover:text-primary transition-colors" data-testid="button-support">Support</button>
            </div>
          </motion.div>
        </div>
      </motion.div>
